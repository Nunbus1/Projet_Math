...
#parser.add_argument("-line_type", help="online, offline, all", type=str, choices=["online", "offline", "all"], default="all")
parser.add_argument("-model", help="Model to use for the prediction", type=str, choices=["next_fit", "best_fit", "harmonic", "first_fit_d", "all"], default="all")
